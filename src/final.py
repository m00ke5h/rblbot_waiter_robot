...
"""
My Name is Mookesh Dash,
This is the Implementation of Task 3 - Waiter bot at cafe for #IRCKT 2021.
"""
...
from tf.transformations import euler_from_quaternion  # For transformations
...
class robot_controller:
    ...
    def __init__(self):
        ...
        # Printing my name.
        rospy.loginfo(CVIOLET2 + CBLINK + "Mookesh Dash's Waiter Robot for Cafe" + CEND)

        # Creating a velocity publisher which publishes to the the topic '/cmd_vel' topic.
        self.vel_pub = rospy.Publisher(name="cmd_vel", data_class=Twist, queue_size=10)

        # Creating a subscriber for the topic '/odom'.
        rospy.Subscriber(name="odom", data_class=Odometry, callback=self.odom_cb)
    ...
    def go(self, goal_x, goal_y, table):
        ...
        threading.Thread(target=lambda: self.run(goal_x, goal_y, table)).start()
    ...
    def run(self, goal_x, goal_y, table):
        ...
        rospy.loginfo(
            (CGREEN2 + "Ready for Next Order" + CEND)
            if not self.es_flag
            else (CRED2 + "Mission Aborted" + CEND)
        )
...
class gui_handler:
    ...
    def table_pressed(self, number):
        """Function responsible for getting which table is pressed and sending the robot its goal based on the table selected.
        ...
        self.robot.go(goal_x=self.goals[g][0], goal_y=self.goals[g][1], table=True)
    ...
    def slider_changed(self, name, value):
        ...
        rospy.loginfo(
            CYELLOW2
            + "Linear velocity value: {}m/s, Angular velocity value: {}rad/s".format(
...
class Ui_Form(object):
    ...
    def setupUi(self, Form):
        ...
        self.emergency_stop_button = QtWidgets.QPushButton(self.Waypoints_frame)
        ...
        self.emergency_stop_button.setMaximumSize(QtCore.QSize(16777215, 16777215))
        font = QtGui.QFont()
        font.setFamily("Open Sans")
        ...
        self.table5_button.setStyleSheet("background-color: rgb(252, 233, 79);")
        ...
        self.table2_button.setStyleSheet("background-color: rgb(252, 233, 79);")
        ...
        self.table3_button.setStyleSheet("background-color: rgb(252, 233, 79);")
        ...
        self.table1_button.setStyleSheet("background-color: rgb(252, 233, 79);")
        ...
        self.table4_button.setStyleSheet("background-color: rgb(252, 233, 79);")
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Mookesh' RBLbot Control"))
        ...
        self.home_button.setToolTip(_translate("Form", "Return to Home Button"))
        ...
        self.av_slider.setToolTip(
            _translate("Form", "Slider for control of Angular Velocity")
        )
        self.lv_slider.setToolTip(
            _translate("Form", "Slider for control of Linear Velocity")
        )
